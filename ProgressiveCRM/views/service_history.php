...
<div class="wrapper">
    ...
    <div class="main-content">
        <header class="p-3 bg-white border-bottom shadow-sm d-flex align-items-center">
            ...
            <h5 class="mb-0 text-dark fw-semibold">Customer Service History</h5>
        </header>

        <div class="container-fluid p-4">
            
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="fw-bold"><i class="bi bi-journal-text text-primary me-2"></i> History for: <span class="text-muted fs-5"><?php echo htmlspecialchars($custId); ?></span></h4>
                <a href="index.php?action=create_service&cust_id=<?php echo urlencode($custId); ?>" class="btn btn-primary shadow-sm">
                    <i class="bi bi-arrow-left me-1"></i> Back to Service Form
                </a>
            </div>
                                    ...
                                    <?php foreach ($historyRecords as $record): ?>
                                        <tr>
                                            ...
                                            <td class="py-3 text-center">
                                                <?php echo $record['extended_warranty'] === 'Yes' ? '<span class="badge bg-success">Yes</span>' : '<span class="text-muted">-</span>'; ?>
                                            </td>
                                            <td class="py-3 text-center">
                                                <?php echo $record['amc'] === 'Yes' ? '<span class="badge bg-success">Yes</span>' : '<span class="text-muted">-</span>'; ?>
                                            </td>
                                            <td class="py-3 text-center">
                                                <?php echo $record['insurance_renewal'] === 'Yes' ? '<span class="badge bg-success">Yes</span>' : '<span class="text-muted">-</span>'; ?>
                                            </td>
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="7" class="px-4 py-5 text-center text-muted">
                                            ...
                                            No past service records found for this customer.
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
